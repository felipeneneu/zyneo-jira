    ...
    return (
      <div className="grid gap-6">
        ...
        <div className="space-y-2">
           <h3 className="text-sm font-semibold text-gray-900">Resumo Executivo</h3>
           ...
           {data.todayFocus && (
            <div className="rounded-xl border border-amber-100 bg-amber-50 p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="text-sm font-semibold text-amber-900">Foco Principal</h4>
              </div>
              <p className="text-sm font-medium text-amber-900 mb-1">{data.todayFocus.title}</p>
              <p className="text-xs text-amber-700/80">{data.todayFocus.description}</p>
            </div>
           )}
           ...
           {data.trend && (
             <div className="rounded-xl border border-gray-100 bg-gray-50 p-4">
               <div className="flex items-center gap-2 mb-2">
                 ...
                 <h4 className="text-sm font-semibold text-gray-900">Tendência</h4>
               </div>
          ...
          {data.pending && data.pending.length > 0 && (
             <div className="space-y-2">
               <div className="flex items-center gap-2">
                 ...
                 <h4 className="text-sm font-semibold text-gray-900">Atenção Necessária</h4>
               </div>
